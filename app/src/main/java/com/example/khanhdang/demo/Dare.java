...
public class Dare extends AppCompatActivity {
    ...
    Button btnBackToWelcome, btnDoneDare;
    TextView txtvDareContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Dare"); //Set title for the activity.

        //Map the variables with xml file.
        btnBackToWelcome = (Button)findViewById(R.id.buttonBackToWelcome);
        btnDoneDare = (Button)findViewById(R.id.buttonDoneDare);
        txtvDareContent = (TextView)findViewById(R.id.textViewDareContent);
        ...
        btnDoneDare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent truthOrDare = new Intent(Dare.this, TruthOrDare.class);
                Toast nextPlayer = Toast.makeText(Dare.this, "Next Player", Toast.LENGTH_SHORT);
                nextPlayer.show();
        ...
        if (bd!=null) {
            String content = bd.getString("dareContent");
            txtvDareContent.setText(content);
        }
        //Press the "Main menu" button to go back to Welcome activity.
        btnBackToWelcome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent welcome = new Intent(Dare.this, Welcome.class);
